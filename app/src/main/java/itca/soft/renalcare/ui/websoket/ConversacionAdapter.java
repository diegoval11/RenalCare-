...
public class ConversacionAdapter extends RecyclerView.Adapter<ConversacionAdapter.ConversacionViewHolder> {
    ...
    public ConversacionAdapter(List<Conversacion> conversaciones, OnConversacionClickListener listener) {
    ...
    public void onBindViewHolder(ConversacionViewHolder holder, int position) {
        ...
        holder.tvHora.setText(formatearHora(conv.getTimestamp_ultimo()));
    ...
    public static class ConversacionViewHolder extends RecyclerView.ViewHolder {
        ...
        public ConversacionViewHolder(View itemView) {
            super(itemView);
            tvNombre = itemView.findViewById(R.id.tv_conversacion_titulo);
            tvUltimoMensaje = itemView.findViewById(R.id.tvUltimoMensaje);
            tvHora = itemView.findViewById(R.id.tv_conversacion_fecha);
